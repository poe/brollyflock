...
//Propigation showMovement(firstShow,PropigationSteps);

ColorScheme showColors(colorScheme,colorSteps);
...
/*      Serial.print(" delay = ");
      ...
      Serial.print("\t red  = ");
      Serial.print(firstBrollies[i].currentColor.red);
      Serial.print("\t green  = ");
      Serial.print(firstBrollies[i].currentColor.green);
      Serial.print("\t blue  = ");
      Serial.print(firstBrollies[i].currentColor.blue);
      Serial.print("\t millis = ");
      Serial.print(millis());
